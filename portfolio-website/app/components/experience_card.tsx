                                ...
                                <div>
                                    ...
                                    <div className={`grid gap-3 ${highlightsOpen ? "block" : "hidden"} lg:grid`}>
                                        {highlights.map((item, index) => (
                                            <div
                                                key={index}
                                                className="relative pixel-border-sm bg-[var(--accent-soft)] p-3 text-[var(--section-alt-foreground)]"
                                                onMouseEnter={() => item.celebrate && setCelebrateIndex(index)}
                                            ...
                                            >
                                                ...
                                                {/* 🎉 Floating Celebrate UI (like your image) */}
                                                {item.celebrate && celebrateIndex === index && (
                                                    <div className="absolute -top-10 left-1/2 z-20 -translate-x-1/2">
                                                        <button
                                                            onClick={triggerConfetti}
                                                            className="pixel-btn flex items-center gap-2 bg-[var(--accent)] px-3 py-2 text-[var(--accent-foreground)] shadow-[3px_3px_0px_black]"
                                                        >
                                                            🎉 Celebrate?
                                                        </button>

                                                        {/* little arrow */}
                                                        <div className="mx-auto h-2 w-2 rotate-45 bg-[var(--accent)] border-b-2 border-r-2 border-black" />
                                                    </div>
                                                )}
                                            </div>
                                        ))}
